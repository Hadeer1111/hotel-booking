...
const rooms_resource_controller_1 = require("./rooms-resource.controller");
...
exports.RoomsModule = RoomsModule = __decorate([
    (0, common_1.Module)({
        imports: [auth_module_1.AuthModule, hotels_module_1.HotelsModule],
        controllers: [rooms_controller_1.RoomsController, rooms_resource_controller_1.RoomsResourceController],
